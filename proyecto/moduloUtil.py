...
def mostrarTRansaccion(idCuenta,tipoTransaccion,monto):
    print(f"Se ha realizado una transaccion de tipo {tipoTransaccion} por un monto de {monto} en la cuenta con id {idCuenta}")
